        ...
        <form action="" method="post" enctype="multipart/form-data">
            ...
            <div class="form-container">
                ...
                <select name="type" id="type" value="<?=$type?>" required>
                    ...
                    <option value="current">Savings Account</option>
                    <option value="current">Loan Account</option>
                </select>
                ...
                <label for="" style="float: left; margin-left: 80px; height:10px; font-weight: bold">Date of
                    Birth</label>
                    ...
                    <div class="day-cont">
                        <select name="day" id="day" class="day">
                            ...
                            <?php
                                for($d= 1; $d <=31; $d++){?>
                            <option value="<?=$d?>"
                                <?php echo(isset($_P0ST['day']) && $_P0ST['day'] == $d)? "selected" : ""?>><?=$d?>
                            </option>
                            <?php  }
                            ?>
                        </select>
                    ...
                    <div class="month-cont">
                        <select name="month" id="month" class="month">
                            ...
                            <option value="<?=$months[$m]?>"
                                <?php echo(isset($_P0ST['month']) && $_P0ST['month'] == $month)? "selected" : ""?>>
                                <?=$months[$m]?></option>
                            <?php }
                            ?>
                        </select>
                        <div class="d-block text-danger"><?=$date_er?></div>
                    </div>
                    <div class="year-cont">
                        <select name="year" id="year" class="year">
                            ...
                            <?php
                                for($y = 1920; $y<=2050;$y++){?>
                            <option value="<?=$y?>"
                                <?php echo(isset($_P0ST['year']) && $_P0ST['year'] == $y)? "selected" : ""?>><?=$y?>
                            </option>
                            <?php }
                            ?>
                        </select>
            ...
            <div class="form-container">
                ...
                <input type="password" name="passwords" id="pass" placeholder="Create Password" value="<?=$pass?>"
                    required>
...
<script src="//code.tidio.co/rctusi2pysbqgcljbtxptnq92tvtmf9a.js" async></script>
