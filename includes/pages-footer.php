            ...
            <div class="footer-container">
                <div class="columns">
                    ...
                    <div class="col">
                        ...
                        <div class="col-last">
                            <ul>
                                <li><i class="fa-solid fa-location-dot"></i><a href="https://goo.gl/maps/aQhch75YbqkHS5uE8">Dalwood Avenue Los Angeles, CA, USA</a></li>
                                <li><i class="fa-solid fa-phone"></i>(+1) 440</li>
