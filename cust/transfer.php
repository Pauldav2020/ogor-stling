...
<div class="column-large" id="col-large">
    <div class="transfer">
        ...
        <ul class="transactions">
            <li><a href="#" id="brookline-acc" onclick="document.getElementById('brookline').style.display='block'">Other STARLING Account <i class="fa-solid fa-angles-right"></i></a></li>
